...
# Load the data set from the file, ignoring the run types
...
# Calculate the actual ground truths, which are defined based on whether AP is above or below a certain threshold
