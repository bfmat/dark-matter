...
#     for initial_threshold in [0.01]:
#         for threshold_multiplier in [1.05]:
#             for l2_lambda in [0]:
#                 for dropout in [0.5]:
...
for initial_training_examples, initial_threshold, threshold_multiplier, l2_lambda, dropout in [[128, 0.02, 1.05, 0.001, 0.25], [256, 0.01, 1.05, 0, 0.5]]: 
    ...
    for configuration_test_index in range(3):
        ...
        description = f'icn_train/dropout{dropout}/l2_lambda{l2_lambda}/initial_examples{initial_training_examples}/initial_threshold{initial_threshold}/threshold_multiplier{threshold_multiplier}/configuration_test{configuration_test_index}'
