...
for dropout, l2_lambda, training_examples in [[0, 0.003, 128], [0.25, 0.003, 256]]:
    ...
    for configuration_test_index in range(3):
        ...
        description = f'banded_grid_new/dropout{dropout}/l2_lambda{l2_lambda}/training_examples{training_examples}/configuration_test{configuration_test_index}'
