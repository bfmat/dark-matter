...
# Iterate over possible configurations for the number of training examples, the L2 lambda, and dropout regularization
for training_examples in [32, 64, 128, 256]:
    for l2_lambda in [0, 0.001, 0.003]:
        for dropout in [0, 0.25, 0.5]:
            ...
            for configuration_test_index in range(3):
                ...
                print('Initial training examples:', training_examples)
                ...
                description = f'banded_grid_search/dropout{dropout}/l2_lambda{l2_lambda}/training_examples{training_examples}/configuration_test{configuration_test_index}'
