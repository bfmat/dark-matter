...
# for definitive_training_examples in [256]:
#     for gravity_multiplier_increment in [0.001]:
...
for definitive_training_examples, gravity_multiplier_increment, learning_rate, distortion_power in [[128, 0.0005, 0.03, 11]]:
    for configuration_test_index in range(3):
        ...
        description = f'gravitational_train/definitive_training_examples{definitive_training_examples}/gravity_multiplier_increment{gravity_multiplier_increment}/learning_rate{learning_rate}/distortion_power{distortion_power}/configuration_test{configuration_test_index}'
